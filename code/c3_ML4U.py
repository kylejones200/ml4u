...
def regression_example(df):
    ...
    sp.savefig(config["plotting"]["output_files"]["regression"])


def generate_classification_data():
    """
    Generate synthetic classification data: equipment age, load -> failure
    probability.
    """
...
def clustering_example():
    ...
    sp.style_line_plot(ax)
    sp.savefig(config["plotting"]["output_files"]["clustering"])
